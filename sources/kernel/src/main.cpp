...
extern "C" unsigned char __main_task[];
extern "C" unsigned int __main_task_len;
...
extern "C" int _kernel_main(void)
{
	...
	sProcessMgr.Create_Process(__main_task, __main_task_len, false);
	...
	// povolime IRQ UARTu  
	sUART0.Enable_IRQ();
	// povolime IRQ UARTu - asi neni treba, funguje to i tak.. mozna to je pro druhy UART?
